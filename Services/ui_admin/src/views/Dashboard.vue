...
import { getTruyenList } from '../server/OtruyenAPI';
...
const loadTruyenList = async () => {
  try {
    const response = await getTruyenList();
    truyenList.value = response.data.items; 
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-12">
            <mini-statistics-card
              ...
              :icon="{
                component: 'ni ni-cloud-download-95',
